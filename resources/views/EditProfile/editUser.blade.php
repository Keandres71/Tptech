...
<div class="wrapper-proyect">
    <div class="form-container user-update">

        <h2 class="saludo">Actualizar Datos</h2>
        <a href="{{ route('NewPassword') }}"> Cambiar contraseña</a>
        @include('layouts.mensaje-error')

        <form action="{{route('changeProfile')}}" method="POST" class="user-update-form-grid">
            @csrf
            @method('PUT')
            ...
            <div class="input-field apellido">
            ...
            <div class="input-field numeroDoc">
            ...
            @enderror
            <button type="submit"  class="login-btn button-update">
                Guardar Cambios
            </button>
